...
if [ $1 = 0 ]
 then
 	sudo sed -i "76s/Enable=1/Enable=0/1" /etc/mmdvmhost
	sudo sed -i "124s/Enable=1/Enable=0/1" /etc/mmdvmhost
 else 	
...
if [ $2 = 0 ]
 then
        ...
        sudo sed -i "87s/Enable=0/Enable=1/1" /etc/mmdvmhost
        sudo sed -i "132s/Enable=0/Enable=1/1" /etc/mmdvmhost
fi


if [ $3 = 0 ]
 then
	sudo sed -i "101s/Enable=1/Enable=0/1" /etc/mmdvmhost
	sudo sed -i "143s/Enable=1/Enable=0/1" /etc/mmdvmhost
 else
	sudo sed -i "101s/Enable=0/Enable=1/1" /etc/mmdvmhost
	sudo sed -i "143s/Enable=0/Enable=1/1" /etc/mmdvmhost
 fi
